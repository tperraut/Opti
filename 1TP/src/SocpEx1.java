...
public final class SocpEx1 {
    ...
    private static IloObjective createmodel(IloCplex cplex,
        ...
        IloNumVar u = cplex.numVar(0, Double.POSITIVE_INFINITY, "u");
        IloNumVar r = cplex.numVar(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, "r");
        IloNumVar s = cplex.numVar(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, "s");
        IloNumVar v = cplex.numVar(0, Double.POSITIVE_INFINITY, "v");
        IloNumVar t = cplex.numVar(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, "t");
        IloNumVar x = cplex.numVar(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, "x");
        IloNumVar y = cplex.numVar(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, "y");

        IloObjective obj = cplex.addMinimize(cplex.sum(u, v), "obj");

        IloRange c1 = (IloRange) cplex.addEq(cplex.sum(x, 2), r, "c1");
        IloRange c2 = (IloRange) cplex.addEq(cplex.sum(y, 1), s, "c2");
        IloRange c3 = (IloRange) cplex.addEq(cplex.sum(y, x), t, "c3");
        IloRange c4 = (IloRange) cplex.addLe(cplex.sum(cplex.prod(r, r),
                cplex.prod(s, s)), cplex.prod(u, u), "c4");
        IloRange c5 = (IloRange) cplex.addLe(cplex.prod(t, t), cplex.prod(v, v), "c5");
